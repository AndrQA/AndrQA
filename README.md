...
<br>
  <p>Чему я научился:<p>
<li>Работать с документацией проекта. Тестировать требования к документации.</li>
<li>Составлять тест-план проекта.</li>
<li>Проводить приемочное и smoke тестирование.</li>
<li>Проводить функциональное, нефункциональное и регресс тестирование. Составлять чек-листы.</li>
<li>Составлять отчеты о проведенном тестировании.</li>
<li>Находить уязвимости и баги.</li>
<li>Работать со swagger.</li>
<li>Углубился в понимании и практическом применение полученных знаний в тестировании GUI и API.</li>
